...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-12 animate-fade-in">
      <header className="text-center py-16 px-4 bg-card rounded-xl shadow-inner-lg" style={{backgroundImage: 'radial-gradient(circle at top right, hsl(var(--primary) / 0.1), transparent 40%)'}}>
          <h1 className="text-5xl font-bold font-headline text-primary">Eternal Echoes</h1>
      ...
      <div className="space-y-4">
        <h2 className="text-3xl font-bold font-headline">Today's Note</h2>
        {todaysNote ? (
      ...
      {latestNote && latestNote.date !== today && (
         <div className="space-y-4">
            <h2 className="text-3xl font-bold font-headline">Latest Memory</h2>
